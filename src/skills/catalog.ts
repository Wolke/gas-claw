...
export const SKILLS:SkillDefinition[]=[
 {id:'daily-brief',title:'每日工作簡報',triggers:['晨報','今日簡報','今天要做什麼'],tools:['calendar.list','gmail.search','tasks.list'],instructions:'列出今天的行程、到期任務與重要未讀郵件。先給三項優先行動，再依時間排序；只摘要，不寄信。',approval:[]},
 {id:'task-manager',title:'自然語言任務管理',triggers:['新增任務','完成任務','延後任務','列出任務'],tools:['tasks.list','tasks.create'],instructions:'先確認任務標題；日期不明時不要猜。gas-claw 本機任務可直接改，Google Tasks 寫入需要核准。',approval:['tasks.create']},
 ...
 {id:'email-follow-up',title:'郵件跟進',triggers:['追蹤郵件','回覆草稿','沒回信提醒'],tools:['gmail.search','gmail.createDraft','gmail.sendDraft'],instructions:'可自動搜尋、摘要與建立草稿；寄送前必須顯示收件者、主旨、本文摘要並取得核准。',approval:['gmail.sendDraft']},
